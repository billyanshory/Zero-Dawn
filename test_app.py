...
class DistribusiKupon(db.Model):
    ...
    nik = db.Column(db.String(255), nullable=False)
        ...
        <div class="w-full">
            ...
            <div class="w-full">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mb-8">
                    ...
                    {% else %}
                    <!-- ACTIVE FORM -->
                    <a href="/idul-adha/absen" class="bg-white p-5 md:p-8 rounded-3xl shadow-lg shadow-amber-200/50 flex flex-col items-center justify-center card-hover h-36 md:h-48 border border-amber-50 group hover:scale-105 hover:shadow-2xl transition-all duration-300 relative cursor-pointer block">
...
@app.route('/idul-adha/peta', methods=['GET'])
