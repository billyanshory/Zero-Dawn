...
class _RequestIdFilter(logging.Filter):
    def filter(self, record):
        try:
            ...
            # Jika dipanggil saat server baru booting (belum ada request), kasih tanda strip saja
            record.request_id = '-'
        return True
...
def index() -> Response | str | tuple[Response, int]:
    ...
    # list_siswa = get_list_siswa_cached() # Matikan sementara
    list_siswa = [] # Ambil langsung
