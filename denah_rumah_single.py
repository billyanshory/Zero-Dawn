...
<body>
    ...
    <div id="hud-container" class="glass-panel">
        ...
        <div id="hud-cam">Zoom: 1.00x | Yaw: 0°</div>
    ...
    <div id="cam-controls" class="glass-panel">
        <button class="cam-btn" data-pitch="0">Front 0°</button>
        <button class="cam-btn" data-pitch="45">ISO 45°</button>
        <button class="cam-btn" data-pitch="90">Top 90°</button>
    </div>
