...
def show_splash_screen(screen):
    ...
    font_powered = pygame.font.SysFont("arial", 12)
    ...
    while True:
        ...
        # Background utama (Simulasi desktop background gelap)
        screen.fill((50, 50, 50))
        
        # Gambar Box Putih
        pygame.draw.rect(screen, white, box_rect)
        pygame.draw.rect(screen, (200, 200, 200), box_rect, 1) # Border halus
        ...
        header_bg_rect = pygame.Rect(box_x + 20, box_y + 20, header_bg_w, header_bg_h)
        
        pygame.draw.rect(screen, light_blue_bg, header_bg_rect)
        screen.blit(txt_surf, txt_surf.get_rect(center=header_bg_rect.center))
        
        # 2. Fitur Minimize dan Close (Kanan Atas)
        # Minimalis: _ X
        min_rect = pygame.Rect(box_x + box_w - 70, box_y + 10, 30, 30)
        close_rect = pygame.Rect(box_x + box_w - 35, box_y + 10, 30, 30)
        
        # Simbol
        pygame.draw.line(screen, (50, 50, 50), (min_rect.centerx - 5, min_rect.centery), (min_rect.centerx + 5, min_rect.centery), 2)
