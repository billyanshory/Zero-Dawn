    ...
    return [
        {
            ...
            "sold": "1,205x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 18:15",
        ...
        },
        {
            ...
            "sold": "2,450x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 18:20",
        ...
        },
        {
            ...
            "sold": "890x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 10:00",
        ...
        },
        {
            ...
            "sold": "1,100x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "20 Oktober 2025 - 14:30",
        ...
        },
        {
            ...
            "sold": "Out of Stock", "stock": "0", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 09:00",
        ...
        },
        {
            ...
            "sold": "5,600x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 19:45",
        ...
        },
        {
            ...
            "sold": "3,100x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 15:30",
        ...
        },
        {
            ...
            "sold": "750x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "19 Oktober 2025 - 11:20",
        ...
        },
        {
            ...
            "sold": "2,200x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 14:00",
        ...
        },
        {
            ...
            "sold": "Out of Stock", "stock": "0", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 08:30",
        ...
        },
        {
            ...
            "sold": "950x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 12:15",
        ...
        },
        {
            ...
            "sold": "1,500x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 17:00",
        ...
        },
        {
            ...
            "sold": "800x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "20 Oktober 2025 - 13:00",
        ...
        },
        {
            ...
            "sold": "Out of Stock", "stock": "0", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 08:00",
        ...
        },
        {
            ...
            "sold": "4,200x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 19:00",
        ...
        },
        {
            ...
            "sold": "650x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "18 Oktober 2025 - 20:00",
        ...
        },
        {
            ...
            "sold": "1,050x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 13:45",
        ...
        },
        {
            ...
            "sold": "3,000x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 11:30",
        ...
        },
        {
            ...
            "sold": "3,800x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 19:30",
        ...
        },
        {
            ...
            "sold": "2,900x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 16:20",
        ...
        },
        {
            ...
            "sold": "4,500x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 18:50",
        ...
        },
        {
            ...
            "sold": "2,700x", "stock": "Digital Key", "author": "GameVerse Official", "updated": "21 Oktober 2025 - 11:10",
        ...
        },
        {
            ...
            "sold": "Out of Stock", "stock": "0", "author": "GameVerse Official", "updated": "22 Oktober 2025 - 07:00",
...
STYLES_HTML = """
    <style>
        ...
        /* Modal Styles specific to purchase flow */
        .purchase-modal {
        ...
        .btn-cancel:hover { background: #ff4757; color: white; box-shadow: 0 0 10px #ff4757; }
        ...
        .btn-confirm:hover { background: var(--neon-green); color: black; box-shadow: 0 0 10px var(--neon-green); }
...
<body class="lang-mode-id">
            ...
            <div class="mini-card" onclick="openModal('{{ game.id }}')">
                ...
                <div class="mini-info">
                    ...
                    <div class="card-bottom-row">
                        ...
                        <button class="btn-buy-card" onclick="event.stopPropagation(); openBuyModal('{{ game.id }}')">
                            Beli
                        </button>
                    </div>
                </div>
                ...
                <div class="mini-card h-100">
                     ...
                     <div class="mini-info">
                        ...
                        <div class="card-bottom-row">
                            ...
                            <button class="btn-buy-card" onclick="alert('Coming Soon!')">Pre-Order</button>
                        </div>
                     </div>
                </div>
            </div>
    ...
    <!-- 2. BUY CONFIRMATION MODAL -->
    <div id="buy-confirm-modal" class="game-modal-overlay">
        <div class="modal-card purchase-modal" onclick="event.stopPropagation()">
            <div class="pm-header">Konfirmasi Pembelian</div>
            <div id="buy-details">
                <!-- Populated by JS -->
            </div>
            <div class="pm-btn-group">
                <button class="btn-cancel" onclick="closeBuyModal()">Batal</button>
                <button class="btn-confirm" onclick="proceedToPayment()">Lanjut Beli</button>
            </div>
        </div>
    </div>

    <!-- 3. PAYMENT METHOD MODAL -->
    <div id="payment-method-modal" class="game-modal-overlay">
        <div class="modal-card purchase-modal" onclick="event.stopPropagation()">
            <div class="pm-header">Pilih Metode Pembayaran</div>
            <div style="width:100%">
                <div class="payment-option" onclick="selectPayment('BRI')">
                    ...
                    <div>
                        ...
                        <span style="font-size:0.8rem; color:#aaa;">No. 123 xxx xxx xxx</span>
                    </div>
                </div>
                <div class="payment-option" onclick="selectPayment('DANA')">
                    ...
                    <div>
                        ...
                        <span style="font-size:0.8rem; color:#aaa;">08990992392</span>
                    </div>
                </div>
            </div>
            <div class="pm-btn-group">
                <button class="btn-cancel" onclick="closePaymentModal()">Kembali</button>
            </div>
        </div>
    </div>

    <!-- 4. CONFIRMATION DONE MODAL -->
    <div id="payment-done-modal" class="game-modal-overlay">
        <div class="modal-card purchase-modal" onclick="event.stopPropagation()">
            <div class="pm-header">Sudah Membayar?</div>
            <p>Jika sudah, langsung klik logo WhatsApp ini dan jangan lupa kirim screenshot bukti pembayaran.</p>
            
            <a href="#" id="wa-link" target="_blank" class="whatsapp-pulse">
                <i class="fab fa-whatsapp"></i>
            </a>
            
            <p style="font-size:0.8rem; color:#aaa;">Klik logo di atas untuk konfirmasi otomatis ke Admin.</p>
            
            <div class="pm-btn-group">
                <button class="btn-cancel" onclick="closeAllModals()">Tutup</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function openBuyModal(id) {
            ...
            const html = `
                <div class="pm-detail-row"><span>Produk</span> <strong style="color:#00f3ff">${selectedGame.title}</strong></div>
                <div class="pm-detail-row"><span>Harga</span> <strong>${selectedGame.price}</strong></div>
                <div class="pm-detail-row"><span>🛒 Terjual</span> <span>${selectedGame.sold}</span></div>
                <div class="pm-detail-row"><span>📦 Stok</span> <span>${selectedGame.stock}</span></div>
                <div class="pm-detail-row"><span>📝 Author</span> <span>${selectedGame.author}</span></div>
                <div class="pm-detail-row"><span>⏳ Update</span> <span>${selectedGame.updated}</span></div>
            `;
            
            document.getElementById('buy-details').innerHTML = html;
        ...
        function selectPayment(method) {
            closePaymentModal();
            document.getElementById('payment-done-modal').classList.add('active');
            
            // Prepare WA Link
            const phone = "6281241865310";
            const text = `Permisi ka, ijin konfirmasi saya sudah membayar, konfirmasi pembayaran transfernya saya tautkan dengan screenshot yaa, terima kasih.%0A%0ADetail Order:%0AProduk: ${selectedGame.title}%0AHarga: ${selectedGame.price}%0AMetode: ${method}`;
            document.getElementById('wa-link').href = `https://wa.me/${phone}?text=${text}`;
        }
        
        function closeAllModals() {
            document.querySelectorAll('.game-modal-overlay').forEach(el => el.classList.remove('active'));
        }
