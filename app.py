        ...
        <div class="w-full">
            ...
            <div class="w-full">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mb-8">
                    ...
                    <a href="/admin/qurban/hewan" class="bg-white p-5 md:p-8 rounded-3xl shadow-lg shadow-[#8B2635]/10 flex flex-col items-center justify-center card-hover h-36 md:h-48 border border-[#8B2635]/5 group hover:scale-105 hover:shadow-2xl transition-all duration-300">
